        ...
        <div class="container">
          <div class="row slider-text justify-content-center align-items-center">
            ...
            <div class="col-md-7 col-sm-12 text-center ftco-animate">
            	<h1 class="mb-3 mt-5 bread">Najčešća pitanja</h1>
      ...
      <div class="container">
        <div class="row d-flex">
          <?php
							...
							$upit ="SELECT * FROM postovi p INNER JOIN slike s ON p.idSlike=s.idSlike";
              ...
              ?>
                ...
                <div class="blog-entry align-self-stretch">
                  <a href="#" class="block-20" style="background-image: url('assets/images/<?=$p->putanja?>');">
                  </a>
                  <div class="text py-4 d-block">
                    <h3 class="heading mt-2"><a href="#"><?=$p->pitanje?></a></h3>
                    <p><?=$p->odgovori?></p>
                  </div>
                </div>
                </div>
